			...
			<table class="table table-striped table-bordered">
				...
				@foreach($photos as $photo)
					<tr>
						...
						<td class="text-center">
						    <a href="{{ Config::get('app-default.galleries_photo_dir') }}/{{ $photo->image }}" target="_blank"><img src="{{ Config::get('app-default.galleries_thumb_dir') }}/{{ $photo->image }}" /></a>
						</td>
						<td class="text-center">
						...
						<td class="text-center">
							...
							<a class="btn btn-default margin-top-10" href="{{ link::auth($module['rest'].'/edit/'.$photo->id) }}">
								Изменить
							</a>
    						@endif
                            --}}
