...
class AdminPagesController extends BaseController {
    ...
    public static $name = 'admin_pages';
    ...
    public static function returnInfo() {
        return array(
        	'name' => self::$name,
        	'group' => self::$group,
        	'title' => 'Страницы', #trans('modules.pages.menu_title'),
            'link' => self::$group,
            'class' => 'fa-list-alt', 
            'show_in_menu' => 1,
        );
	...
	public function getIndex(){
		...
		return View::make($this->tpl.'index',array('pages' => $pages, 'locales' => $this->locales));
	}
	...
	public function getCreate(){
		...
		return View::make($this->tpl.'create',array('templates'=>$this->templates(),'languages'=>Language::all(), 'locales' => $this->locales));
	}
	...
	public function getEdit($id){
		...
		return View::make($this->tpl.'edit',array('page'=>$page, 'page_meta'=>$page_meta, 'templates'=>$this->templates(),'languages'=>Language::all(), 'locales' => $this->locales));
	...
	public function getMenu(){
		...
		return View::make($this->tpl.'menu', compact('bread', 'pages'));
	}
