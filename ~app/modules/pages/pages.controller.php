...
class PagesController extends BaseController {
    ...
    public static function returnRoutes($prefix = null) {
        ...
        if (is_array(Config::get('app.locales')) && count(Config::get('app.locales'))) {
            ...
            foreach(Config::get('app.locales') as $locale) {
                ...
                Route::group(array('before' => 'i18n_url', 'prefix' => $locale), function(){
                    Route::any(link::rel('/{url}'), array('as' => 'page',     'uses' => __CLASS__.'@showPageByUrl')); ## I18n Pages
                    Route::any(link::rel('/'),      array('as' => 'mainpage', 'uses' => __CLASS__.'@showPageByUrl')); ## I18n Main Page
                });
            }
        }
        ...
        Route::group(array('before' => 'i18n_url'), function(){
            ...
            ## I18n Pages
            Route::any(link::rel('/{url}'), array('as' => 'page', 'uses' => __CLASS__.'@showPageByUrl'));
            ## I18n Main Page
            Route::any(link::rel('/'), array('as' => 'mainpage', 'uses' => __CLASS__.'@showPageByUrl'));
