		...
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<table class="table table-striped table-bordered">
				<thead>
					...
					@if(Allow::action('articles','publication'))
				...
				@foreach($articles as $article)
					<tr>
						...
						@endif
						@if(Allow::action('articles','delete'))
