...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="pull-right margin-bottom-25 margin-top-10 ">
			<a class="btn btn-primary" href="{{ link::auth('languages/create') }}">Добавить язык</a>
		</div>
	</div>
</div>
@endif;
				...
				<tr>
					...
					<td>
						@if(Allow::valid_action_permission('languages','edit'))
							<a class="btn btn-labeled btn-success pull-left margin-right-10" href="{{ link::auth('languages/edit/'.$language->id) }}">
								<span class="btn-label"><i class="fa fa-edit"></i></span> Ред.
							</a>
						@endif
						@if(Allow::valid_action_permission('languages','delete'))
							<form method="POST" action="{{ link::auth('languages/destroy/'.$language->id) }}">
